...
public class EditUser extends javax.swing.JDialog {
     ...
     */
    public EditUser(java.awt.Frame parent, boolean modal , UserDAO userDao , String username ,String password , int id) {
        super(parent, modal);
        initComponents();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addComponent(id_user, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        var iSsucces = userDao.updateUser(Integer.parseInt(id_user.getText()), username_txt.getText(), password_txt.getText());
        if (iSsucces) {
            JOptionPane.showMessageDialog(rootPane, "berhasil update user");
            dispose();
        } else {
            JOptionPane.showMessageDialog(rootPane, "gagal update user");
        }
